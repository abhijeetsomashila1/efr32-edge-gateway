...
extern sl_iostream_t *sl_iostream_esp32_handle;
extern sl_iostream_uart_t *sl_iostream_uart_esp32_handle;
...
sl_power_manager_on_isr_exit_t sl_iostream_eusart_esp32_sleep_on_isr_exit(void);
